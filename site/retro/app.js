...
(function () {
  ...
  var compact = typeof window.matchMedia === 'function' ? window.matchMedia('(max-width: 800px)') : null;
  var preference = null;
  ...
  before.addEventListener('click', function () { showIcons(false); });
  after.addEventListener('click', function () { showIcons(true); });
